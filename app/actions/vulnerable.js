...
export async function saveVulnerableData(prevState, formData) {
    ...
    // Only SSO (and ADMIN/HEALTH_REGION for override) can manage this data
    if (!['SSO', 'ADMIN', 'HEALTH_REGION'].includes(user.role)) {
        return { message: 'สิทธิ์การจัดการข้อมูลสำหรับ สสอ. เท่านั้น', success: false }
    }
