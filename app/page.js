        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {/* 1.1 Record Measures - For SSJ, SSO, ADMIN and HEALTH_REGION */}
              {(user?.role === 'SSJ' || user?.role === 'SSO' || user?.role === 'ADMIN' || user?.role === 'HEALTH_REGION') && (
                <DashboardCard
                  title="บันทึกมาตรการ"
          ...
          <section>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              />
              {(['SSJ', 'ADMIN', 'HEALTH_REGION', 'HOSPITAL', 'PCU'].includes(user?.role)) && (
                <DashboardCard
